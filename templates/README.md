...
4. **`/resolve-incident`** — added 2026-05-28, **retired 2026-08-15**. It was `incident-log-template.md`'s only writer. Codex `$resolve-repository-problem` reuses an existing repository-approved task or incident record when one exists and does not inherit this template or create a second issue lifecycle.
