...
- Files in scope: the 18 files carried by the branch (mechanically derived from `git diff --stat main...session/2026-07-13-research-workflow`); audits/lean-repo-2026-07-13.md; docs/session-marker.md; logs/session-notes.md; logs/session-plan-2026-07-14-S1.md; logs/friction-log.md; logs/improvement-log.md; audits/risk-checks/2026-07-14-land-research-workflow-branch-m1-orphan-lens-fold.md; logs/runs/2026-07-14-S1.json
