...
### 2026-06-05 — Date-qualify session-plan filename (id-41, deferred from S6 friday-act)
- **Status:** logged (pending)
- **Severity:** MED
...
- **Target files:** see consumer inventory above (≈10 runtime files + 1 hook + ~6 docs; both `wrap-session.md` copies in lockstep).
- **Blocked by:** dedicated session + /risk-check.
