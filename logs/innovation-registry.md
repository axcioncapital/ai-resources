...
| 2026-05-26 | skill | ai-resources/skills/source-class-mapper/SKILL.md | pending-triage | Bundle 1 of source-pipeline workflow fix (slimmed S-10); project-agnostic Pass 1 sub-agent; created via /create-skill pipeline (evaluator subagent + Step 4 auto-fix triage applied) |
| 2026-05-26 | skill | ai-resources/skills/country-parity-checker/SKILL.md | pending-triage | Bundle 1 of source-pipeline workflow fix (slimmed S-10); project-agnostic Pass 3 sub-agent with parameterized verdict labels; created via /create-skill |
| 2026-05-26 | skill | ai-resources/skills/claim-permission-gate/SKILL.md | pending-triage | Bundle 1 of source-pipeline workflow fix (slimmed S-10); Opus tier; Mitigation 4+ regime disclosure fires conditional on counter-search sentinel absence; created via /create-skill |
| 2026-05-26 | command | ai-resources/workflows/research-workflow/.claude/commands/run-sufficiency.md | pending-triage | Bundle 1 of source-pipeline workflow fix (slimmed S-10); Opus; Pass 3 orchestrator with 5 phases (A,C,D,E,F; B reserved); excluded from auto-sync via EXCLUDE_COMMANDS — workflow-scoped, deployed via /sync-workflow only |
...
| 2026-06-04 | command | /Users/patrik.lindeberg/Claude Code/Axcion AI Repo/projects/research-pe-regime-shift-advisory-gap/.claude/commands/run-sufficiency.md | detected | — |
