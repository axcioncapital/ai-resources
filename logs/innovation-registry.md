...
| 2026-05-16 | settings-pattern | projects/nordic-pe-macro-landscape-H1-2026/.claude/settings.json#UserPromptSubmit-decision-log | triaged:graduate-stale | → ai-resources workflows level; logs GATE/PAUSE decisions to decisions.md (12d stale at 2026-05-28 fix-plan wave-1 — no specific target file named) |
| 2026-05-16 | settings-pattern | projects/nordic-pe-macro-landscape-H1-2026/.claude/settings.json#Stop-checkpoint-nag | triaged:graduate-stale | → ai-resources workflows level; fires if no checkpoint written in 120min (12d stale at 2026-05-28 fix-plan wave-1 — no specific target file named) |
