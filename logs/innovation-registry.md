...
| 2026-05-16 | settings-pattern | projects/nordic-pe-macro-landscape-H1-2026/.claude/settings.json#SessionStart-upward-walk | triaged:graduate | → ai-resources/docs/permission-template.md; confirmed by repo-documentation independently |
| 2026-05-16 | settings-pattern | projects/repo-documentation/.claude/settings.json#SessionStart-upward-walk | triaged:graduate | same pattern as nordic-pe entry above; two-project confirmation |
| 2026-05-16 | settings-pattern | projects/interpersonal-communication/.claude/settings.json#deny-archive | triaged:graduate | → ai-resources/docs/permission-template.md; generalizable Read-deny for archive/deprecated dirs |
| 2026-05-16 | settings-pattern | projects/nordic-pe-macro-landscape-H1-2026/.claude/settings.json#UserPromptSubmit-decision-log | triaged:graduate | → ai-resources workflows level; logs GATE/PAUSE decisions to decisions.md |
| 2026-05-16 | settings-pattern | projects/nordic-pe-macro-landscape-H1-2026/.claude/settings.json#Stop-checkpoint-nag | triaged:graduate | → ai-resources workflows level; fires if no checkpoint written in 120min |
| 2026-05-16 | settings-pattern | projects/nordic-pe-macro-landscape-H1-2026/.claude/settings.json#PostToolUse-5hook-taxonomy | triaged:graduate | → ai-resources/docs/permission-template.md wiring reference (auto-commit hook is loose-end) |
| 2026-05-16 | claude-md | projects/interpersonal-communication/CLAUDE.md#Compaction | triaged:graduate | → ai-resources/docs/compaction-protocol.md; "trust summary, cost-test first" rule |
