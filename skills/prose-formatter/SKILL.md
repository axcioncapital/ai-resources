...
- Trigger #1 (parallel items → list; threshold = `5+` default or runtime override): [FIRED at lines [n-m] — "[brief description]"] or [NOT FIRED]
