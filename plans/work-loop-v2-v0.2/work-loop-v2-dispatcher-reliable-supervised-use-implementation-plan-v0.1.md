...
**Date:** 2026-08-16  
**Status:** PROVISIONAL — scoped plan for operator approval after the durable-state branch is accepted and merged. It does not authorize implementation against the current pre-merge baseline.  
